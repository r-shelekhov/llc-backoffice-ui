...
export const communications: Communication[] = [
  ...
  // Conversation conv-2 communications (Ashworth jet charter - in_review)
  {
    ...
    sender: "client",
    senderName: "James Ashworth",
    message: "Need a G650 for Geneva this weekend. Six of us plus full ski gear. And please arrange Dorchester catering — the full menu, not the standard selection.",
    channel: "phone",
    tags: ["vip", "urgent"],
  ...
  },
  {
    ...
    sender: "client",
    senderName: "James Ashworth",
    message: "Yes, G-LUXE. Manifest attached. Also add ground transport on the Geneva side — two Range Rovers at the airport.",
    channel: "email",
    tags: ["vip"],
    attachments: [
      {
  ...
  // Conversation conv-5 communications (Sheikh yacht - awaiting_client)
  {
    ...
    sender: "agent",
    senderName: "Marcus Chen",
    message: "Sheikh Al-Fayed, we have identified three superyachts meeting your specifications for Monaco GP weekend. The 88m 'Eclipse II' with harbour-front position is my top recommendation. Deck plans and crew profiles attached.",
    channel: "concierge",
    tags: ["vip", "urgent"],
    attachments: [
      {
  ...
  // Conversation conv-14 communications (Mei Lin jet - in_review)
  {
    ...
    message: "Need Challenger 350 London to Edinburgh for March 12. Four passengers. Can you confirm the crew? Also, we have specific dietary requirements — no shellfish for two passengers.",
    channel: "whatsapp",
  ...
  // Conversation conv-23 communications (Ashworth yacht follow-up - awaiting_client)
  {
    ...
    sender: "client",
    senderName: "James Ashworth",
    message: "Marcus, regarding the Mediterranean charter — I want the same captain from last year, Captain Morrison. Also add the Jet Ski package and the 40ft tender, not the 30ft. My children will be joining this time.",
    channel: "concierge",
    tags: ["vip", "urgent"],
  ...
  // Conversation conv-6 communications (Sheikh jet - new)
  {
    ...
    sender: "client",
    senderName: "Sheikh Omar Al-Fayed",
    message: "I require a BBJ for my delegation travelling to London on March 15. Twenty passengers. The aircraft must have a full bedroom suite. Catering by Al Reef — they know my requirements.",
    channel: "phone",
    tags: ["vip"],
