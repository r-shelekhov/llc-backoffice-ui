...
export const internalNotes: InternalNote[] = [
  ...
  // Notes for conv-2 (Ashworth jet charter)
  {
    ...
    authorId: "usr-3",
    content: "Client strongly prefers tail G-LUXE — same aircraft used in November. Operator confirmed availability. Dorchester catering contact: Chef Williams direct line. He knows Mr. Ashworth's preferences (no wasabi, extra toro, specific champagne: Krug Grande Cuvée).",
  ...
  },
  {
    ...
    conversationId: "conv-2",
    authorId: "usr-4",
    content: "Geneva ground transport: Two black Range Rover Sports confirmed with Geneva Luxury Cars. Driver briefed to wait at FBO, not on tarmac. Ski equipment will need the extended cargo configuration.",
